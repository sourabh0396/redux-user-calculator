...
//     <div style={containerStyle} >
//     <div><Link to="/calculator" className='header-nav-link' style={{color:'black',border:'2px'}}>X</Link></div>
//       <h2>Profile</h2>
//       {editMode ? (
//         <form style={formStyle} onSubmit={handleSubmit}>
//           <div>
...
//       ) : (
//         <div>
//                     <p style={infoStyle}><strong>Logo:</strong> <img src={userData.logo} alt="Logo" style={{ width: '100px',height:'100px', borderRadius: '4px' }} /></p>
//           <p style={infoStyle}><strong>First Name:</strong> {userData.firstName}</p>
//           <p style={infoStyle}><strong>Last Name:</strong> {userData.lastName}</p>
//           <p style={infoStyle}><strong>Email:</strong> {userData.email}</p>
//           <p style={infoStyle}><strong>Age:</strong> {userData.age}</p>
//           <p style={infoStyle}><strong>Home Address:</strong> {userData.homeAddress}</p>
//           <p style={infoStyle}><strong>Primary Color:</strong> {userData.primaryColor}</p>
//           <p style={infoStyle}><strong>Secondary Color:</strong> {userData.secondaryColor}</p>
...
// // // import { fetchUserProfile } from './redux/profileSlice'; // Action from profileSlice
...
// //       <p><strong>Primary Color:</strong> {userData.primaryColor}</p>
// //       <p><strong>Secondary Color:</strong> {userData.secondaryColor}</p>
// //       <p><strong>Logo:</strong> <img src={userData.logo} alt="Logo" style={{ width: '100px' }} /></p>
// //       {error && <p style={{ color: 'red' }}>{error}</p>}
// //     </div>
// //   );
// // };
