...
//           <div style={{display:'grid',gridTemplateColumns:'5fr 5fr',marginLeft:'10px',marginRight:'10px',gap:'20px'}}>
//                   <input
//                     type="text"
//                     name="firstName"
//                     value={formData.firstName}
...
//                   {errors.lastName && <p className='error'>{errors.lastName}</p>}
//           </div>          
//           <div style={{display:'grid',gridTemplateColumns:'10fr',marginLeft:'10px',marginRight:'10px'}}>
//               <input
//                 type="email"
//                 name="email"
//                 value={formData.email}
...
//           <div  style={{display:'grid',gridTemplateColumns:'7fr 3fr',marginLeft:'10px',marginRight:'10px',gap:'20px'}}>
//           <input
//             type="password"
//             name="password"
//             value={formData.password}
...
//           <div style={{display:'grid',gridTemplateColumns:'5fr 5fr',margin:'10px',gap:'20px'}}>
//                 <span>Primary Color:</span>  <input type="color" name="primaryColor" value={formData.primaryColor} onChange={handleInputChange} required
//                   />                  
//                 <span>Secondary Color:</span>  <input type="color" name="secondaryColor" value={formData.secondaryColor} onChange={handleInputChange} required
//                   />
//           </div>
